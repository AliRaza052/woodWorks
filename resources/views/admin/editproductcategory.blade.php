...
<div class="container-fluid">
    ...
    @endif
        ...
        <div class="add-listing-box general-info mrg-bot-25 padd-bot-30 padd-top-25">
            ...
            <form action="{{route('updateproductcategory',$product->id)}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="d-flex justify-content-start align-items-center">
                            <button type="submit" class="btn bg-blue ml-10">Update Product category<i class="icon-paperplane ml-2"></i></button>
                </div>
</form>
</div>
@endsection
